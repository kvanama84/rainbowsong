...
public class Drivers {
	public static WebDriver getDriver(String browser){
			...
			if (browser.equals("ie")){
				driver = new FirefoxDriver();//its not firefox
			}else if (browser.equals("firefox")){
				System.setProperty("webdriver.firefox.driver", "C:\\Users\\admin\\Desktop\\browser\\geckodriver-v0.21.0-win64\\geckodriver.exe");
